package com.example.sanjeedha.Paths.model;
...
import com.example.sanjeedha.Paths.control.DijkstraShortestPathAlg;
...
public class VariableGraph extends Graph
{
    ...
    public static void main(String[] args)
    {
        ...
        VariableGraph graph = new VariableGraph("/Users/haroon/Projects/djikstra/app/data/test_50");
